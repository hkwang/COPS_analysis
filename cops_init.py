...
class InitWindow(Toplevel):
    ...
    def create_widgets(self):
        ...
        self.main.ent1=Entry(self,font=self.main.font_text, width=40)
        self.main.ent1.grid(row=4,column=1, columnspan=3)
        ...
        self.main.ent3=Entry(self,font=self.main.font_text, width=40)
        self.main.ent3.grid(row=8,column=1, columnspan=3)
        ...
        self.main.ent4=Entry(self,font=self.main.font_text, width=40)
        self.main.ent4.grid(row=10,column=1, columnspan=3)
        ...
        self.main.ent5=Entry(self,font=self.main.font_text, width=40)
        self.main.ent5.grid(row=12,column=1, columnspan=3)
        ...
        self.main.ent6=Entry(self,font=self.main.font_text, width=40)
        self.main.ent6.grid(row=14,column=1, columnspan=3)
        ...
        self.main.ent7=Entry(self,font=self.main.font_text, width=40)
        self.main.ent7.grid(row=16,column=1, columnspan=3)
